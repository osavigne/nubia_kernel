...
{
	printk("BMS capacity=%d current=%d ibat_ua=%d vbat_uv=%d dc_chg_in=%d usb_chg_in=%d\n",
			power_debug_information.battery_information.percent_of_battery,
			power_debug_information.battery_information.battery_current,
			power_debug_information.battery_information.ibat_ua,
			power_debug_information.battery_information.vbat_uv,
			power_debug_information.battery_information.dc_chg_in,
